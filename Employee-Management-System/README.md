...
│   ├── pages/addEmployee.html
│   ├── pages/editEmployee.html
│   ├── pages/employeeDetails.html
│   ├── pages/404.html
│   └── index.html
└── README.md
```
...
- Make sure `JWT_SECRET` is secure in production.
- Use modern browsers for best UX.
- The frontend stores the JWT in localStorage for demo purposes.
